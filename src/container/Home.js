...
// import CardComponent from '../Views/CardComponent'; '../Views/CardComponent';
...
const Home = () => {
    return (
        ...
        <div>
            {/* <h1 className={' bg-slate-500 text-slate-300 hover:bg-slate-900 text-2xl align text-center'}>MENU MAKAN RESTAURANT SEDERHANA
            </h1>
            <CardComponent
                link="/Profile"
                time="7.30"
                title="Nasi Goreng "
                desc="Dengan harga Rp 20.000 kalian sudah kenyang "
            ...
            <CardComponent
                ...
                time="7.25"
                title="Pasta "
                desc="Dengan harga Rp 50.000 anda sudah merasakan kelezatannya "
            ...
            <CardComponent
                ...
                time="7.50"
                title="Burger"
                desc="Dengan harga Rp 30.000 anda sudah dapat varian daging "
            ...
            <CardComponent
                ...
                time="7.35"
                title="Ikan Bakar"
                desc="Dengan harga Rp 25.000 anda merasakan masakannya sekelas "
